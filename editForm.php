        ...
        <div class="wrapper wrapper--w900">
            <div class="card card-6">
                <div class="card-heading">
                    <h2 class="title">Edit shift info</h2>
                </div>
                <div class="card-body">
                    <form method="POST" action='add.php'>
                    <div class="form-row">
                            <div class="name">Shift ID</div>
                            <div class="value">
                                <input class="input--style-6" type="number" name="shift_id" placeholder="Enter the shift_id you want to edit">
                            </div>
                        </div>
                        <div class="form-row">
