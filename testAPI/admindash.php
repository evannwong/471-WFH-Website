          ...
          <div class="row">
            <div class="col-md-6 mb-4 stretch-card transparent">
              <div class="card card-light-danger">
                ...
                <a href="https://shardarquraishi.com/dbproj/admin_do_mantainance.php">
                  <div class="card-body">

                    <p class="fs-30 mb-2">Perform mantainance</p>
                          ...
                          <div class="row">
                            <div class="col-md-12 col-xl-3 d-flex flex-column justify-content-start">
                              <div class="ml-xl-4 mt-3">
                                ...
                                ?>
                                <h3 class="font-weight-500 mb-xl-4 text-primary">Count: <?php echo $numOfUsers ?></h3>
                                <!-- <p class="mb-2 mb-xl-0">NUMBER OF WORKING SHIFTS = ? FROM ? TO ?</p> -->
                              </div>
                              <div class="ml-xl-4 mt-3">
                                <p class="card-title">Deleted Users to mantain</p>
                                <!-- PERFORM QUERY to get total number of users to fully delete: count the rows in user_login table -->
                                <!-- <h1 class="text-primary">1</h1> -->
                                <?php
                                $query = "SELECT * FROM `mantainance`";
                                $result = $connect->query($query);
                                $numOfUsers = mysqli_num_rows($result);
                                ?>
                                <h3 class="font-weight-500 mb-xl-4 text-primary">Count: <?php echo $numOfUsers ?></h3>
